...
struct Font {
    static let DEFAULT_SMALL_SIZE: CGFloat = 10
    static let DEFAULT_SIZE: CGFloat = 16
    static let DEFAULT_LARGE_SIZE: CGFloat = 16
    static let READ_TEXT_SIZE: CGFloat = 12
    static let SECONDARY_SIZE: CGFloat = 11
